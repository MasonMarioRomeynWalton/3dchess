...
class game():
    def restart(self):
        ...
        self.king1 = piecec('king',[5, 1, 1],0)
        self.pawn1 = piecec('pawn',[1, 3, 2],0)
        self.pawn2 = piecec('pawn',[2, 3, 2],0)
        self.pawn3 = piecec('pawn',[3, 3, 2],0)
        self.pawn4 = piecec('pawn',[4, 3, 2],0)
        self.pawn5 = piecec('pawn',[5, 3, 2],0)
        self.pawn6 = piecec('pawn',[6, 3, 2],0)
        self.pawn7 = piecec('pawn',[7, 3, 2],0)
        self.pawn8 = piecec('pawn',[8, 3, 2],0)
        self.pawn9 = piecec('pawn',[1, 2, 3],0)
        self.pawn10 = piecec('pawn',[2, 2, 3],0)
        self.pawn11 = piecec('pawn',[3, 2, 3],0)
        self.pawn12 = piecec('pawn',[4, 2, 3],0)
        self.pawn13 = piecec('pawn',[5, 2, 3],0)
        self.pawn14 = piecec('pawn',[6, 2, 3],0)
        self.pawn15 = piecec('pawn',[7, 2, 3],0)
        self.pawn16 = piecec('pawn',[8, 2, 3],0)
        self.peasant1 = piecec('peasant',[1, 3, 1],0)
        self.peasant2 = piecec('peasant',[2, 3, 1],0)
        self.peasant3 = piecec('peasant',[3, 3, 1],0)
        self.peasant4 = piecec('peasant',[4, 3, 1],0)
        self.peasant5 = piecec('peasant',[5, 3, 1],0)
        self.peasant6 = piecec('peasant',[6, 3, 1],0)
        self.peasant7 = piecec('peasant',[7, 3, 1],0)
        self.peasant8 = piecec('peasant',[8, 3, 1],0)
        self.peasant9 = piecec('peasant',[1, 1, 3],0)
        self.peasant10 = piecec('peasant',[2, 1, 3],0)
        self.peasant11 = piecec('peasant',[3, 1, 3],0)
        self.peasant12 = piecec('peasant',[4, 1, 3],0)
        self.peasant13 = piecec('peasant',[5, 1, 3],0)
        self.peasant14 = piecec('peasant',[6, 1, 3],0)
        self.peasant15 = piecec('peasant',[7, 1, 3],0)
        self.peasant16 = piecec('peasant',[8, 1, 3],0)
        self.soldier1 = piecec('soldier',[1, 3, 3],0)
        self.soldier2 = piecec('soldier',[2, 3, 3],0)
        self.soldier3 = piecec('soldier',[3, 3, 3],0)
        self.soldier4 = piecec('soldier',[4, 3, 3],0)
        self.soldier5 = piecec('soldier',[5, 3, 3],0)
        self.soldier6 = piecec('soldier',[6, 3, 3],0)
        self.soldier7 = piecec('soldier',[7, 3, 3],0)
        self.soldier8 = piecec('soldier',[8, 3, 3],0)
        self.knight1 = piecec('knight',[1, 2, 1],0)
        self.knight2 = piecec('knight',[4, 2, 2],0)
        self.knight3 = piecec('knight',[5, 2, 2],0)
        self.knight4 = piecec('knight',[8, 2, 1],0)
        self.horse1 = piecec('horse',[1, 2, 2],0)
        self.horse2 = piecec('horse',[2, 2, 1],0)
        self.horse3 = piecec('horse',[7, 2, 1],0)
        self.horse4 = piecec('horse',[8, 2, 2],0)
        self.elephant1 = piecec('elephant',[1, 1, 2],0)
        self.elephant2 = piecec('elephant',[2, 2, 2],0)
        self.elephant3 = piecec('elephant',[7, 2, 2],0)
        self.elephant4 = piecec('elephant',[8, 1, 2],0)
        self.rook1 = piecec('rook',[1, 1, 1],0)
        self.rook2 = piecec('rook',[3, 2, 2],0)
        self.rook3 = piecec('rook',[6, 2, 2],0)
        self.rook4 = piecec('rook',[8, 1, 1],0)
        self.bishop1 = piecec('bishop',[2, 1, 2],0)
        self.bishop2 = piecec('bishop',[3, 2, 1],0)
        self.bishop3 = piecec('bishop',[6, 2, 1],0)
        self.bishop4 = piecec('bishop',[7, 1, 2],0)
        self.cardinal1 = piecec('cardinal',[2, 1, 1],0)
        self.cardinal2 = piecec('cardinal',[3, 1, 2],0)
        self.cardinal3 = piecec('cardinal',[6, 1, 2],0)
        self.cardinal4 = piecec('cardinal',[7, 1, 1],0)
        self.queen1 = piecec('queen',[3, 1, 1],0)
        self.queen2 = piecec('queen',[6, 1, 1],0)
        self.duchess1 = piecec('duchess',[4, 1, 2],0)
        self.duchess2 = piecec('duchess',[5, 1, 2],0)
        self.princess1 = piecec('princess',[4, 2, 1],0)
        self.princess2 = piecec('princess',[5, 2, 1],0)
        self.pope1 = piecec('pope',[4, 1, 1],0)
