...
class game():
    def restart(self):
        ...
        self.king1     = piecec('king',    [0, 4, 0],0)
        self.pawn1     = piecec('pawn',    [1, 0, 2],0)
        self.pawn2     = piecec('pawn',    [1, 1, 2],0)
        self.pawn3     = piecec('pawn',    [1, 2, 2],0)
        self.pawn4     = piecec('pawn',    [1, 3, 2],0)
        self.pawn5     = piecec('pawn',    [1, 4, 2],0)
        self.pawn6     = piecec('pawn',    [1, 5, 2],0)
        self.pawn7     = piecec('pawn',    [1, 6, 2],0)
        self.pawn8     = piecec('pawn',    [1, 7, 2],0)
        self.pawn9     = piecec('pawn',    [2, 0, 1],0)
        self.pawn10    = piecec('pawn',    [2, 1, 1],0)
        self.pawn11    = piecec('pawn',    [2, 2, 1],0)
        self.pawn12    = piecec('pawn',    [2, 3, 1],0)
        self.pawn13    = piecec('pawn',    [2, 4, 1],0)
        self.pawn14    = piecec('pawn',    [2, 5, 1],0)
        self.pawn15    = piecec('pawn',    [2, 6, 1],0)
        self.pawn16    = piecec('pawn',    [2, 7, 1],0)
        self.peasant1  = piecec('peasant', [0, 0, 2],0)
        self.peasant2  = piecec('peasant', [0, 1, 2],0)
        self.peasant3  = piecec('peasant', [0, 2, 2],0)
        self.peasant4  = piecec('peasant', [0, 3, 2],0)
        self.peasant5  = piecec('peasant', [0, 4, 2],0)
        self.peasant6  = piecec('peasant', [0, 5, 2],0)
        self.peasant7  = piecec('peasant', [0, 6, 2],0)
        self.peasant8  = piecec('peasant', [0, 7, 2],0)
        self.peasant9  = piecec('peasant', [2, 1, 0],0)
        self.peasant10 = piecec('peasant', [2, 1, 0],0)
        self.peasant11 = piecec('peasant', [2, 2, 0],0)
        self.peasant12 = piecec('peasant', [2, 3, 0],0)
        self.peasant13 = piecec('peasant', [2, 4, 0],0)
        self.peasant14 = piecec('peasant', [2, 5, 0],0)
        self.peasant15 = piecec('peasant', [2, 6, 0],0)
        self.peasant16 = piecec('peasant', [2, 7, 0],0)
        self.soldier1  = piecec('soldier', [2, 0, 2],0)
        self.soldier2  = piecec('soldier', [2, 1, 2],0)
        self.soldier3  = piecec('soldier', [2, 2, 2],0)
        self.soldier4  = piecec('soldier', [2, 3, 2],0)
        self.soldier5  = piecec('soldier', [2, 4, 2],0)
        self.soldier6  = piecec('soldier', [2, 5, 2],0)
        self.soldier7  = piecec('soldier', [2, 6, 2],0)
        self.soldier8  = piecec('soldier', [2, 7, 2],0)
        self.knight1   = piecec('knight',  [0, 0, 1],0)
        self.knight2   = piecec('knight',  [1, 3, 1],0)
        self.knight3   = piecec('knight',  [1, 4, 1],0)
        self.knight4   = piecec('knight',  [0, 7, 1],0)
        self.horse1    = piecec('horse',   [1, 0, 1],0)
        self.horse2    = piecec('horse',   [0, 1, 1],0)
        self.horse3    = piecec('horse',   [0, 6, 1],0)
        self.horse4    = piecec('horse',   [1, 7, 1],0)
        self.elephant1 = piecec('elephant',[1, 0, 0],0)
        self.elephant2 = piecec('elephant',[1, 1, 1],0)
        self.elephant3 = piecec('elephant',[1, 6, 1],0)
        self.elephant4 = piecec('elephant',[1, 7, 0],0)
        self.rook1     = piecec('rook',    [0, 0, 0],0)
        self.rook2     = piecec('rook',    [1, 2, 1],0)
        self.rook3     = piecec('rook',    [1, 5, 1],0)
        self.rook4     = piecec('rook',    [0, 7, 0],0)
        self.bishop1   = piecec('bishop',  [1, 1, 0],0)
        self.bishop2   = piecec('bishop',  [0, 2, 1],0)
        self.bishop3   = piecec('bishop',  [0, 5, 1],0)
        self.bishop4   = piecec('bishop',  [1, 6, 0],0)
        self.cardinal1 = piecec('cardinal',[0, 1, 0],0)
        self.cardinal2 = piecec('cardinal',[1, 2, 0],0)
        self.cardinal3 = piecec('cardinal',[1, 5, 0],0)
        self.cardinal4 = piecec('cardinal',[0, 6, 0],0)
        self.queen1    = piecec('queen',   [0, 2, 0],0)
        self.queen2    = piecec('queen',   [0, 5, 0],0)
        self.duchess1  = piecec('duchess', [1, 3, 0],0)
        self.duchess2  = piecec('duchess', [1, 4, 0],0)
        self.princess1 = piecec('princess',[0, 3, 1],0)
        self.princess2 = piecec('princess',[0, 4, 1],0)
        self.pope1     = piecec('pope',    [0, 3, 0],0)

        self.king2     = piecec('king',    [7, 4, 7],1)
        self.pawn17    = piecec('pawn',    [6, 0, 5],1)
        self.pawn18    = piecec('pawn',    [6, 1, 5],1)
        self.pawn19    = piecec('pawn',    [6, 2, 5],1)
        self.pawn20    = piecec('pawn',    [6, 3, 5],1)
        self.pawn21    = piecec('pawn',    [6, 4, 5],1)
        self.pawn22    = piecec('pawn',    [6, 5, 5],1)
        self.pawn23    = piecec('pawn',    [6, 6, 5],1)
        self.pawn24    = piecec('pawn',    [6, 7, 5],1)
        self.pawn25    = piecec('pawn',    [5, 0, 6],1)
        self.pawn26    = piecec('pawn',    [5, 1, 6],1)
        self.pawn27    = piecec('pawn',    [5, 2, 6],1)
        self.pawn28    = piecec('pawn',    [5, 3, 6],1)
        self.pawn29    = piecec('pawn',    [5, 4, 6],1)
        self.pawn30    = piecec('pawn',    [5, 5, 6],1)
        self.pawn31    = piecec('pawn',    [5, 6, 6],1)
        self.pawn32    = piecec('pawn',    [5, 7, 6],1)
        self.peasant17 = piecec('peasant', [7, 0, 5],1)
        self.peasant18 = piecec('peasant', [7, 1, 5],1)
        self.peasant19 = piecec('peasant', [7, 2, 5],1)
        self.peasant20 = piecec('peasant', [7, 3, 5],1)
        self.peasant21 = piecec('peasant', [7, 4, 5],1)
        self.peasant22 = piecec('peasant', [7, 5, 5],1)
        self.peasant23 = piecec('peasant', [7, 6, 5],1)
        self.peasant24 = piecec('peasant', [7, 7, 5],1)
        self.peasant25 = piecec('peasant', [5, 0, 7],1)
        self.peasant26 = piecec('peasant', [5, 1, 7],1)
        self.peasant27 = piecec('peasant', [5, 2, 7],1)
        self.peasant28 = piecec('peasant', [5, 3, 7],1)
        self.peasant29 = piecec('peasant', [5, 4, 7],1)
        self.peasant30 = piecec('peasant', [5, 5, 7],1)
        self.peasant31 = piecec('peasant', [5, 6, 7],1)
        self.peasant32 = piecec('peasant', [5, 7, 7],1)
        self.soldier9  = piecec('soldier', [5, 0, 5],1)
        self.soldier10 = piecec('soldier', [5, 1, 5],1)
        self.soldier11 = piecec('soldier', [5, 2, 5],1)
        self.soldier12 = piecec('soldier', [5, 3, 5],1)
        self.soldier13 = piecec('soldier', [5, 4, 5],1)
        self.soldier14 = piecec('soldier', [5, 5, 5],1)
        self.soldier15 = piecec('soldier', [5, 6, 5],1)
        self.soldier16 = piecec('soldier', [5, 7, 5],1)
        self.knight5   = piecec('knight',  [7, 0, 6],1)
        self.knight6   = piecec('knight',  [6, 3, 6],1)
        self.knight7   = piecec('knight',  [6, 4, 6],1)
        self.knight8   = piecec('knight',  [7, 7, 6],1)
        self.horse5    = piecec('horse',   [6, 0, 6],1)
        self.horse6    = piecec('horse',   [7, 1, 6],1)
        self.horse7    = piecec('horse',   [7, 6, 6],1)
        self.horse8    = piecec('horse',   [6, 7, 7],1)
        self.elephant5 = piecec('elephant',[6, 0, 7],1)
        self.elephant6 = piecec('elephant',[6, 1, 6],1)
        self.elephant7 = piecec('elephant',[6, 6, 6],1)
        self.elephant8 = piecec('elephant',[6, 7, 7],1)
        self.rook5     = piecec('rook',    [7, 0, 7],1)
        self.rook6     = piecec('rook',    [6, 2, 6],1)
        self.rook7     = piecec('rook',    [6, 5, 6],1)
        self.rook8     = piecec('rook',    [7, 7, 7],1)
        self.bishop5   = piecec('bishop',  [6, 1, 7],1)
        self.bishop6   = piecec('bishop',  [7, 2, 6],1)
        self.bishop7   = piecec('bishop',  [7, 5, 6],1)
        self.bishop8   = piecec('bishop',  [6, 6, 7],1)
        self.cardinal5 = piecec('cardinal',[7, 1, 7],1)
        self.cardinal6 = piecec('cardinal',[6, 2, 7],1)
        self.cardinal7 = piecec('cardinal',[6, 5, 7],1)
        self.cardinal8 = piecec('cardinal',[7, 6, 7],1)
        self.queen3    = piecec('queen',   [7, 2, 7],1)
        self.queen4    = piecec('queen',   [7, 5, 7],1)
        self.duchess3  = piecec('duchess', [6, 3, 7],1)
        self.duchess4  = piecec('duchess', [6, 4, 7],1)
        self.princess3 = piecec('princess',[6, 3, 6],1)
        self.princess4 = piecec('princess',[7, 4, 6],1)
        self.pope2     = piecec('pope',    [7, 3, 7],1)
